...
class User(Base):
    ...
    require_push_approval: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class Run(Base):
    ...
    issue_labels: Mapped[Optional[list[str]]] = mapped_column(JSON, nullable=True)
    branch_name: Mapped[str] = mapped_column(String(255), nullable=False)
    status: Mapped[str] = mapped_column(String(64), default="queued")
    stage: Mapped[str] = mapped_column(String(64), default="queued")
    error: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    gitops_output: Mapped[Optional[dict[str, Any]]] = mapped_column(JSON, nullable=True)
